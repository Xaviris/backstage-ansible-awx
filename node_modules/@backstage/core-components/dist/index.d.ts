...
/** @public */
type SidebarIntroClassKey = 'introCard' | 'introDismiss' | 'introDismissLink' | 'introDismissText' | 'introDismissIcon';
type IntroCardProps = {
    text: string;
    onClose: () => void;
};
 ...
 *
 */
declare function IntroCard(props: IntroCardProps): React__default.JSX.Element;
declare function SidebarIntro(_props: {}): React__default.JSX.Element | null;
